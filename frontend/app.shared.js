(() => {
    ...
    const dom = {
        ...
        territoryCollapseBtn: $("#territoryCollapseBtn"),
        territoryExpandBtn: $("#territoryExpandBtn"),
        ...
        lassoToggle: $("#lassoToggle"),
        searchExpand: $("#searchExpand"),
        lassoExpand: $("#lassoExpand"),
        ...
        ingestRecent: $("#ingestRecent"),
        ingestRecentList: $("#ingestRecentList"),
        ingestBreadcrumb: $("#ingestBreadcrumb"),
        ingestDirList: $("#ingestDirList"),
    };
    ...
    const state = {
        ...
        searchMatches: null,
        directorySpotlight: "",
        activeFilters: { extension: null, status: null },
        overseenDirs: [],
        ...
        animTime: 0,
        fitDone: false,
        territoryCollapsed: localStorage.getItem("hs5_territory_collapsed") === "true",
        searchOpen: false,
